...
public class ListenerOrIncomingConnectionTest {
    ...
    public void testDefaultConstructor() throws Exception {
        Field fListeningOnPortNumber = mListenerOrIncomingConnection.getClass().getDeclaredField("mListeningOnPortNumber");
        Field fClientPortNumber = mListenerOrIncomingConnection.getClass().getDeclaredField("mClientPortNumber");
        Field fServerPortNumber = mListenerOrIncomingConnection.getClass().getDeclaredField("mServerPortNumber");
    ...
    public void testToJsonObject() throws Exception {
        ...
        mListeningPortNumber = mJSONObject.getInt(JXcoreExtension.CALLBACK_VALUE_LISTENING_ON_PORT_NUMBER);
        mClientPortNumber = mJSONObject.getInt(JXcoreExtension.CALLBACK_VALUE_CLIENT_PORT_NUMBER);
        mServerPortNumber = mJSONObject.getInt(JXcoreExtension.CALLBACK_VALUE_SERVER_PORT_NUMBER);
