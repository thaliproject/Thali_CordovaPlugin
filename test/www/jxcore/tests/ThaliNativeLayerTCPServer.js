/**
 * Created by juksilve on 10.9.2015.
 */
'use strict';
var net = require('net');


function ThaliNativeLayerTCPServer(port) {
    var self = this;
    self.port = port;
...
ThaliNativeLayerTCPServer.prototype.getServerPort = function() {
    return (this.server && this.server.address()) ? this.server.address().port : 0;
}

ThaliNativeLayerTCPServer.prototype.stopServer = function() {
    if(this.server == null) {
        return;
    }
...
module.exports = ThaliNativeLayerTCPServer;